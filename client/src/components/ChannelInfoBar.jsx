        ...
        <div className="bg-[#0a131a] border-b-2 border-secondary/20 px-6 py-3 shadow-sm">
            <div className="flex justify-between items-start">
                <div className="flex-1 min-w-0">
                    ...
                    {channel.description && (
                        <p className="text-sm text-accent1/80 truncate mt-0.5">
                            {channel.description}
                        </p>
                    )}
                </div>
                <div className="flex items-center space-x-2">
                    <button
                        ...
                        className={`flex items-center space-x-1 px-3 py-1 rounded hover:bg-secondary/20 ${showPinnedMessages ? 'bg-secondary/20 text-accent2' : 'text-accent1'}`}
                    >
                    ...
                    <button
                        ...
                        className="flex items-center space-x-1 px-3 py-1 rounded hover:bg-secondary/20 text-accent1"
                    >
